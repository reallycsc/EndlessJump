...
bool CreditScene::init()
{
	...
	{
		auto music_name = musicList->at(i);
		auto label = Label::createWithTTF(music_name.substr(0, music_name.find_last_of(".")), "fonts/fzzj.ttf", 32);
